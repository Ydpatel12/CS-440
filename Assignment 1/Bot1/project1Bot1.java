...
public class project1Bot1 {
    ...
    private static final char BOT_LOCATION = '1';
    ...
    // Add this new method to check if a cell is valid (not blocked, within grid)
    public static boolean notBlocked(char[][] grid, int size, int x, int y) {
        return x >= 0 && x < size && y >= 0 && y < size && grid[x][y] != BLOCKED_CELL;
    }

    public static ArrayList<int[]> BFSBOT1(char[][] array, int size, int[] bot, int[] button) {
    ...
    // Count the number of burning neighbors of a cell
    ...
    public static void main(String[] args) {
        ...
        for (int timeStep = 0; timeStep < size * size; timeStep++) {
            ...
            ArrayList<int[]> bot1Path = BFSBOT1(grid, size, botLoc, buttonLoc);
